...
- When creating modules, features, packages, libraries or composables, ensure to keep the interface minimal and only expose what is necessary for users to interact with and the module deep.
- When writing modules public interfaces should be above private implementations.
